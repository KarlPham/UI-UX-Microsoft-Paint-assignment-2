...
def draw(event, app):
    ...
    if app.shape_mode and app.shape_start_x is not None and app.shape_start_y is not None:
        # Vẽ hình preview với viền có độ dày theo bút
        if app.shape_mode == "rectangle":
            ...
            app.canvas.create_oval(app.shape_start_x, app.shape_start_y, x, y, outline=app.pen_color, width=app.pen_size, tags="preview_shape")
